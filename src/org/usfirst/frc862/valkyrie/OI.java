...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Straight Dynamic Profile", new StraightDynamicProfile());
        ...
        SmartDashboard.putData("Right Dynamic Profile", new RightDynamicProfile());
        SmartDashboard.putData("Left Dynamic Profile", new LeftDynamicProfile());
