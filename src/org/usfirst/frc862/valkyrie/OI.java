...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("FollowDynamicMotionProfile", new FollowDynamicMotionProfile());
        SmartDashboard.putData("TestMotor", new TestMotor());
        SmartDashboard.putData("TestLeftMotor", new TestLeftMotor());
        SmartDashboard.putData("TestRightMotor", new TestRightMotor());
