...
import org.usfirst.frc862.util.POVButton;
...
import org.usfirst.frc862.valkyrie.commands.FOCMotion1;
import org.usfirst.frc862.valkyrie.commands.FOCMotion2;
import org.usfirst.frc862.valkyrie.commands.FOCMotion3;
import org.usfirst.frc862.valkyrie.commands.FOCRotate1;
import org.usfirst.frc862.valkyrie.commands.FOCRotate2;
...
import org.usfirst.frc862.valkyrie.commands.SpinLeft;
import org.usfirst.frc862.valkyrie.commands.SpinRight;
...
public class OI {
    ...
    private POVButton rollLeft;
    private POVButton rollRight;
    private TwoButtonTrigger reverseTrigger;
    ...
    public OI() {
        ...
        SmartDashboard.putData("FOCMotion1", new FOCMotion1());
        SmartDashboard.putData("FOCMotion2", new FOCMotion2());
        SmartDashboard.putData("FOCMotion3", new FOCMotion3());
        SmartDashboard.putData("FOCRotate1", new FOCRotate1());
        SmartDashboard.putData("FOCRotate2", new FOCRotate2());
        ...
        SmartDashboard.putData("FOCHopperDump", new FOCHopperDump());
        SmartDashboard.putData("FOCAutonBlueFeeder", new FOCAutonBlueFeeder());
        SmartDashboard.putData("FOC Auton", new FOCAuton());
...
//        );
          rollLeft = new POVButton(driverLeft, 270);
          rollLeft.whileHeld(new SpinLeft());

          rollRight = new POVButton(driverLeft, 90);
          rollRight.whileHeld(new SpinRight());
        
          reverseTrigger = new TwoButtonTrigger(new JoystickButton(driverRight, 1), new JoystickButton(driverLeft, 1));
          reverseTrigger.whileActive(new ReverseDrive());
    }
