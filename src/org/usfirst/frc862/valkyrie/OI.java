...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Back Off Left", new BackOffLeft());
        SmartDashboard.putData("Drive Left To Launchpad", new DriveLeftToLaunchpad());
        SmartDashboard.putData("Full Left Auton", new FullLeftAuton());
        SmartDashboard.putData("LeftDynamicProfile", new LeftDynamicProfile());
