...
public class OI {
    ...
    public JoystickButton wallFollowMode;
    ...
    public OI() {
        ...
        wallFollowMode = new JoystickButton(driverLeft, 8);
        wallFollowMode.whileHeld(new WallFollow());
        visionAssistGear = new JoystickButton(driverLeft, 14);
        visionAssistGear.whileHeld(new VisionGear());
        visionAssistFeedButton = new JoystickButton(driverLeft, 16);
        ...
        downshiftButton = new JoystickButton(driverLeft, 30);
