...
public class RobotMap {
    ...
    public static DigitalOutput coreLEDBit1;
    public static DigitalOutput coreLEDBit2;
    public static DigitalOutput coreLEDBit3;
    ...
    public static DigitalInput gearDetectorPegSensor;
    ...
    public static StatefulCommand smartAuton;
    ...
    public static void init() {
        ...
        coreLEDBit1 = new DigitalOutput(2);
        LiveWindow.addActuator("Core", "LED Bit 1", coreLEDBit1);
        
        coreLEDBit2 = new DigitalOutput(3);
        LiveWindow.addActuator("Core", "LED Bit 2", coreLEDBit2);
        
        coreLEDBit3 = new DigitalOutput(4);
        LiveWindow.addActuator("Core", "LED Bit 3", coreLEDBit3);
...
//        navx = new AHRS(edu.wpi.first.wpilibj.I2C.Port.kMXP, (byte) 50);
