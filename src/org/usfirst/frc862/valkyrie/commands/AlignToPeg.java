...
public class AlignToPeg extends Command {
    ...
    State state = State.WAIT_FOR_VISION;    
    ...
    protected void execute() {
        ...
        case WAIT_FOR_VISION:
            ...
            if (peg != null && peg.getCaptureTime() > start_time) {
                x = peg.getLongitudinalDistance();
                y = peg.getLatidunalDistance() + 100;
                state = State.CALC_THETA;
            }
            break;
    ...
    protected void end() {
        ...
        Logger.flush();
        DriveDistance.setDistance(LightningMath.mm2ft(distance));
    }
