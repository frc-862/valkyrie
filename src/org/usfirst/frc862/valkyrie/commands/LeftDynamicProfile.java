 ...
 *
 */
public class LeftDynamicProfile extends Command {
    ...
    protected void initialize() {        
        ...
        points.addWaypoint(new WaypointSequence.Waypoint(7.45,-3.17, Math.toRadians(-65))); //left side
