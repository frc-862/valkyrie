...
public class Core extends Subsystem implements Loop {
    ...
    private final DigitalOutput lEDBit1 = RobotMap.coreLEDBit1;
    private final DigitalOutput lEDBit2 = RobotMap.coreLEDBit2;
    private final DigitalOutput lEDBit3 = RobotMap.coreLEDBit3;
...
//        line1.set(value);
        ...
        lEDBit1.set((msg & 0x01) == 0x01);
        lEDBit2.set((msg & 0x02) == 0x02);
        lEDBit3.set((msg & 0x04) == 0x04);
    }
