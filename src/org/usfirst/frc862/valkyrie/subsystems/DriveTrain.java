...
public class DriveTrain extends Subsystem implements Loop {
    ...
    public final AnalogInput ultrasonic = RobotMap.driveTrainUltrasonic;
    ...
    MovingAverageFilter maf = new MovingAverageFilter(10);
    
    public double getUltrasonicValue1() {
    	return maf.filter(ultrasonic.getValue() * (5.0 / 512));
    }
