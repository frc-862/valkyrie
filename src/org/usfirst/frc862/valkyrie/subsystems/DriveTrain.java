...
public class DriveTrain extends Subsystem implements Loop {
    ...
    private final AnalogInput ultrasonic2 = RobotMap.driveTrainUltrasonic2;
    ...
    MovingAverageFilter maf = new MovingAverageFilter(20);
    MovingAverageFilter maf2 = new MovingAverageFilter(20);
    
    public double getUltrasonicValue1() {
    	return maf.filter((ultrasonic.getVoltage() * 1000) / 9.6);
    }
    
    //ExponentialSmoothingFilter esf = new ExponentialSmoothingFilter(0.9);
    
    // #don'tBeASusan
    /*public double getUltrasonicValue2() {
    	return esf.filter((ultrasonic.getVoltage() * 1000) / 9.6);
    }*/
    
    public double getUltrasonicValue2() {
    	return maf2.filter((ultrasonic2.getVoltage() * 1000) / 9.6);
    }
