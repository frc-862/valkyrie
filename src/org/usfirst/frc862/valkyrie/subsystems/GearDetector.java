...
public class GearDetector extends Subsystem {
    ...
    private final DigitalInput gearSensor = RobotMap.gearDetectorGearSensor;
    private final DigitalInput pegSensor = RobotMap.gearDetectorPegSensor;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new GearIndicator());
    ...
    public boolean pegPresent() {
        return this.pegSensor.get();
    }
}
