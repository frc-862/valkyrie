...
public class CoastTrigger extends MonitorTrigger {
    public CoastTrigger(DriveTrain dt, double limit, double duration) {
        // TODO commanded power below calibrated value
        super(duration, () -> {
            return (Math.abs(dt.getAverageVelocity()) < limit) && false;
        });
    }
}